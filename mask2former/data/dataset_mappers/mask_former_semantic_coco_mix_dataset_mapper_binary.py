...
__all__ = ["MaskFormerSemanticCocoMixDatasetMapperBinary"]
...
class MaskFormerSemanticCocoMixDatasetMapperBinary:
    """
    ...
    def __call__(self, dataset_dict):
        ...
        binary_sem_seg_gt[binary_sem_seg_gt == self.ood_label] = 1
